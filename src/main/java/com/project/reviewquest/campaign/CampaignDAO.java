...
public interface CampaignDAO {
    void insertCampaign(CampaignDTO campaignDTO);
    void updateCampaign(CampaignDTO campaignDTO);
    void deleteCampaign(Long id);
    CampaignDTO getCampaignById(Long id);
    List<CampaignDTO> getAllCampaigns(int start, int pageSize);
    void deleteImage(Long campaignId);
    void deleteDetailImage(Long campaignId);
    void deleteSubImage(@Param("campaignId") Long campaignId, @Param("imageFilePath") String imageFilePath);
    // 카테고리별 Campaign 조회 (페이징 처리)
	...
	List<CampaignDTO> getCampaignsBycityMainCategoryAndSubCategory(String city, String mainCategory, String subCategory,
			int page, int pageSize);
	List<CampaignDTO> getCampaignsBycityAndMainCategory(String city, String mainCategory, String mainCategory2, int page, int pageSize);
	...
	int getTotalCampaignsByAllConditions(String city, String region, String mainCategory,
			String subCategory);
	...
	int getTotalCampaignsByCityRegionAndMainCategory(String city, String region);
	...
	ApplicationDTO getregistrationDates(String nickName, Long id);
