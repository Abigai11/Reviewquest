...
<c:choose>  
  ...
  <form action="<c:url value='/admin/addCampaign'/>" method="post" enctype="multipart/form-data">
...
<div class="categorysearch">
              ...
              <div class="category">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="campaignPrice" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="date" name="selectDate" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">캠페인 등록 시작일</label>
                    <input class="form-control" type="date" name="registrationStart" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">캠페인 등록 종료일</label>
                    <input class="form-control" type="date" name="registrationEnd" required>
                  </div>
                </div>
                <div class="col-md-6">
				  <div class="form-group">
				    <label for="example-text-input" class="form-control-label">선정자 수</label>
				    <input class="form-control" type="number" name="selectedCandidates" min="0" required>
				  </div>
				</div>     
              </div>
			...
			<p class="text-uppercase text-sm">캠페인 유형</p>
		        <label>
		            ...
		            <img src="${contextPath }/resources/images/snsIcon/naverblog.png" alt="">
		        </label>
		        <label>
		            <input type="checkbox" id="instagramCheckbox" name="campaignTypes" value="instagram">
		            <img src="${contextPath }/resources/images/snsIcon/instagram.png" alt="">
		        </label>
		        <label>
		            <input type="checkbox" id="youtubeCheckbox" name="campaignTypes" value="youtube">
		             <img src="${contextPath }/resources/images/snsIcon/youtube.png" alt="">
		        </label>	              
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="multiline-input" name="providedDetails" rows="4" cols="50" required></textarea>
	                <div class="col-md-12">
	                  <div class="form-group">
	                    <label for="example-text-input" class="form-control-label">키워드</label>
	                    <input class="form-control" type="text" name="keyword" value="${campaign.keyword}" required>
	                  </div>
	                </div>    
	                <div class="col-md-12">
	                  <div class="form-group">
	                    <label for="example-text-input" class="form-control-label">안내사항</label>
	                     <textarea class="form-control" id="multiline-input" name="notification" rows="4" cols="50" required></textarea>
	                  </div>
	                </div>    
	                <div class="col-md-12">
	                  <div class="form-group">
	                    <label for="example-text-input" class="form-control-label">업체정보</label>
	                   <textarea class="form-control" id="multiline-input" name="companyInformation" rows="4" cols="50" required></textarea>
	                  </div>
	                </div>              
                  </div>
                </div>
...
// campaignType이 "naverblog"이면 checkbox 체크
if (campaignTypes === "naverblog") {
    naverblogCheckbox.checked = true;
} else if (campaignTypes === "instagram") { // 올바른 조건문 형식으로 수정
    instagramCheckbox.checked = true;
} else if (campaignTypes === "youtube") { // 올바른 조건문 형식으로 수정
