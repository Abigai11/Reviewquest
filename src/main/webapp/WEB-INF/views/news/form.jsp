...
<script type="text/javascript">
	$(document).ready(function () {
	    $(".listBtn").on("click", function () {
	        var newUrl = "${contextPath}/forum/listForum";
...
<c:choose>
    <c:when test="${userInfo.division ne 'admin'}">       
...
<form name="regiform" method="post" action="${contextPath}/news/form?name=${userInfo.nickName}" onsubmit="return check_Valid();" enctype="multipart/form-data" target="h_blank">
