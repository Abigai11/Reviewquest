...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$(".listBtn").on("click", function () {
			self.location = "${contextPath}/forum/listForum?page=${newsPage.page}"
			+ "&pageNum=${newsPage.pageNum}"
			+ "&searchType=${newsPage.searchType}"
			+ "&keyword=${newsPage.keyword}";
		});
	});
</script>
<head>
...
<c:choose>
    <c:when test="${empty userInfo || userInfo.division ne 'admin'}">       
    	<div><div class="noto500 ls_1" style="font-size:30px; color:#333; padding-bottom:50px;">관리자만 이용가능합니다.</div></div> 
    	<a href="${contextPath}/news/" class="h_btn_b icon_b uk-icon" uk-icon="icon:list; ratio:1">목록보기<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="list"><rect x="6" y="4" width="12" height="1"></rect><rect x="6" y="9" width="12" height="1"></rect><rect x="6" y="14" width="12" height="1"></rect><rect x="2" y="4" width="2" height="1"></rect><rect x="2" y="9" width="2" height="1"></rect><rect x="2" y="14" width="2" height="1"></rect></svg></a>	               
    </c:when>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
    <c:otherwise>
<form name="regiform" method="post" action="${contextPath}/news/modify" onsubmit="return check_Valid();" enctype="multipart/form-data" target="h_blank">
...
<div style="width:100%;">
	...
	<!-- 게시판상단 -->
	<div><div class="noto500 ls_1" style="font-size:30px; color:#333; padding-bottom:50px;">수정</div></div>
	<!-- 게시판상단 -->

	<div style="border-top:1px solid #4d4d4d;" class="bbs_reg_table">
		<table>
		<tbody>
			<input type="hidden" name="num" value="${newsDTO.num }">
			<input type="hidden" name="page" value="${newsPage.page }">
			<input type="hidden" name="pageNum" value="${newsPage.pageNum }">
			<input type="hidden" name="searchType" value="${newsPage.searchType }">
			<input type="hidden" name="keyword" value="${newsPage.keyword }">
		<tr>
			<th>등록인</th>
			<td class="h_form">
				<input type="text" name="name" value="${newsDTO.name }" readonly disabled>
			</td>
		</tr>
		...
		<tr>
			<th>제목</th>
			<td class="h_form"><input name="title" type="text" value="${newsDTO.title }"></td>
		</tr>
		<tr>
			<td colspan="2" style="padding:10px 0px;">
				<!-- 위지윅 시작 -->
				<!--  에디터 관련 CSS -->
			<textarea id="content" name="content">${newsDTO.content }</textarea>
				<!-- 위지윅끝 -->
			</td>
		</tr>
		</tbody></table>
	...
	<div style="border-top: 1px solid #4d4d4d;" class="h_form bbs_reg_bottom_btn" >
		<div style="display: flex; justify-content: center;">
	    	<div>
			    <a href="${contextPath}/news/" class="uk-icon list_hover" style=" padding: 12px 20px; border: 1px solid #e5e5e5; line-height: 1; border-radius: 4px;">
