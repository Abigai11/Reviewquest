...
<c:choose>
	...
	<!-- 게시판상단 -->
	<div><div class="noto500 ls_1" style="font-size:30px; color:#333; padding:50px 50px; ">기부페이지 작성</div></div>
	<!-- 게시판상단 -->
	...
	<div style="border-top:1px solid #4d4d4d; border-bottom:1px solid #4d4d4d;" class="bbs_reg_table">
		...
		<tr>
			<th>목표날짜</th>
			<td class="h_form"><input name="endDate" type="date" value=""></td>
		</tr>
		<tr>
			<th>목표금액</th>
			<td class="h_form"><input name="targetAmount" type="number" value=""></td>
		</tr>
		<tr>
			<th>첨부파일</th>
			<td class="h_form">
	...
	<div class="h_form bbs_reg_bottom_btn" >
		<div style="display: flex; justify-content: center;">
		    ...
		    <div>
			    <button id="searchBtn" class="write_hover" style=" padding: 12px 20px; border: 1px solid #e5e5e5; line-height: 1; background: #0067ff;color: #ffffff; border-radius: 4px;">
