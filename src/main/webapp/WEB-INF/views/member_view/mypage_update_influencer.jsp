...
<c:choose>
		...
		<div class="mypage_left_menu_sub">
			<div class="mypage_common_box">
				<a href="happy_member.php?mode=camp_join_list&amp;b_stats=10" class="mypage_left_menu_sub_link">
					...
					<tbody><tr>
						<td align="left">리뷰어 신청</td>
						<td align="right" class="count_text">30</td>
					</tr>
					</tbody></table>
				</a>
				<a href="happy_member.php?mode=camp_join_list&amp;b_stats=15" class="mypage_left_menu_sub_link">
					<table style="width:100%">
					<tbody><tr>
						<td align="left">리뷰어 발표대기</td>
						<td align="right" class="count_text">3</td>
					</tr>
					</tbody></table>
				</a>
				<a href="happy_member.php?mode=camp_join_list&amp;b_stats=20" class="mypage_left_menu_sub_link">
					<table style="width:100%">
					<tbody><tr>
						<td align="left">리뷰어 발표</td>
						<td align="right" class="count_text">3</td>
					</tr>
					</tbody></table>
				</a>
				<a href="happy_member.php?mode=camp_join_list&amp;b_stats=30" class="mypage_left_menu_sub_link">
					<table style="width:100%">
					<tbody><tr>
						<td align="left">콘텐츠 등록</td>
						<td align="right" class="count_text">23</td>
					</tr>
					</tbody></table>
				</a>
			</div>
	...
	<div class="mypage_left_menu_main">
		<a href="${pageContext.request.contextPath}/mypage_update_influencer" class="mypage_left_menu_main_link">
			내정보 관리
			<span uk-icon="icon:more-vertical; ratio:1" class="uk-icon"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="more-vertical"><circle cx="10" cy="3" r="2"></circle><circle cx="10" cy="10" r="2"></circle><circle cx="10" cy="17" r="2"></circle></svg></span>
		</a>
		<div class="mypage_left_menu_sub">
			<div class="mypage_common_box">
				<a href="${pageContext.request.contextPath}/mypage_update_influencer" class="mypage_left_menu_sub_link">
					회원정보수정
				</a>
				<a onclick="javascript:window.open('recommend_link.php','recommend_link','width=510, height=360,scrollbars=no,titlebar=no,status=no,resizable=no,fullscreen=no');" class="mypage_left_menu_sub_link">
					추천인 링크발급
				</a>
				<a href="html_file.php?file=my_write.html&amp;file2=happy_member_default_mypage_normal.html" class="mypage_left_menu_sub_link">
					내가 작성한 게시글
				</a>
...
<div class="mypage_common_box">
	...
	<tr>
				...
				<div>
					...
					<div id="passwordMismatchMessage1" class="error-message" style="margin-left:15px;"></div>
							...
							<tr>
								...
								<div style="display: flex;">
									...
									<select style="width:80px;" name="user_email_at_hostSel" id="user_email_at_hostSel" class="join_select_e" onchange="updateInputValue()" required>
										...
										<option value="userInput" selected="">직접입력</option>
									</select> 
							...
							<tr>
								...
								<td class="h_form">
									<input type="text" style="width:80px;" name="phone_first" value="<%= phone_first %>">
									...
									<input type="text" style="width:80px;" name="phone_second" maxlength="4" value="<%= phone_second %>"> - <!-- !! - 기호 지우시면 아니되옵니다!! -->
									<input type="text" style="width:80px;" name="phone_third" maxlength="4" value="<%= phone_third %>">
							...
							<tr>
								...
								<td class="h_form">
									<textarea name="introduce" style="width:100%; height:150px;">${editInfo.introduce}</textarea>
								</td>
							</tr>	
							...
							<tr>
									...
									<td class="h_form">
										<input type="text" name="urlSNS" value="${editInfo.urlSNS}" class="m_w_100" style="width:30%;" > 
								...
								<tr>
									...
									<td class="h_form">
										<input type="text" name="urlYoutube" value="${editInfo.urlYoutube}" class="m_w_100" style="width:30%;"> 
								...
								<tr>
									...
									<td class="h_form">
										<input type="text" name="urlNaver" value="${editInfo.urlNaver}" class="m_w_100" style="width:30%;"> 
		...
		<div class="h_form" style="display:flex; justify-content: center; text-align:center; margin-top:50px;">
			...
			<a href="member/logout?id=${onemember.id}&division=member_delete" class="h_btn_b icon_b uk-icon" uk-icon="icon:close; ratio:1">회원탈퇴<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="close"><path fill="none" stroke="#000" stroke-width="1.06" d="M16,16 L4,4"></path><path fill="none" stroke="#000" stroke-width="1.06" d="M16,4 L4,16"></path></svg></a>
		</div>
	</div>
</div>
</form>
