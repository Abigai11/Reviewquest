	...
	<div class="container">
		<div class="member_agree">
			<h2 style="font-size: 26px; letter-spacing: -1px;  color: #101010; margin: 45px 0 35px 0;">
				<span style="color:#0067ff">업체회원</span> 회원가입 정보입력
					...
					<div>
						...
						<tbody>
							...
							<tr>
								...
								<td class="h_form">
									<input type="text" id="idInput" name="id" class="m_w_100" style="width:20%;" required minlength="8" maxlength="20">
							...
							<tr>
								...
								<td class="h_form">
									...
									<div id="passwordMismatchMessage1" class="error-message"></div>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="h_form">
									<input type="password" name="password2" class="m_w_100" style="width:20%;" required>
							...
							<tr>
								...
								<div style="display: flex;">
									<input type="text" name="email_at_user" class="join_input_e_01"> @ 
									<input type="text" name="email_at_host" id="user_email_at_host" class="join_input_e_02"> 
				...
				<td class="h_form">
					...
					<span class="guide_txt">1:1 비율로 맞춰주세요 </span>
							...
							<tr>
								...
								<td class="h_form">
									<input type="text" name="companyName" value="" class="m_w_100" style="width:20%;" maxlength="10" required>
							...
							<tr>
								...
								<td class="h_form">
									<input type="text" id="businessNOInput"  name="businessNO" class="m_w_100" style="width:20%;" maxlength="10" required>
									<span id="businessNO_resultMessage" class="check_txt"></span>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="h_form">
									<input type="text" name="companyTel" class="m_w_100" style="width:20%;" maxlength="10">
									<span class="guide_txt"></span>
								</td>
...
function combineAndSubmit()
{
	...
	var isBusinessNOValid = validbusinessNOForm();
  
    if (!isBusinessNOValid || !isPhoneValid) {
